...
from news_paper.views import News, New, FilterNews, PostDeleteView, PostUpdateView, \
    PostAddView,  IndexView, BaseRegisterView, upgrade_me 
...
urlpatterns = [
    ...
    path('signup/', BaseRegisterView.as_view(template_name='signup.html'), name='registration'),
